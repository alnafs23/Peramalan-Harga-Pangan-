...
Proyek ini menggabungkan d # Peramalan Harga Sembako & Korelasi dengan Statistik Fintech P2P Lending (OJK)

![Python](https://img.shields.io/badge/Python-3.10%2B-blue)
![License](https://img.shields.io/badge/data-non--komersial-lightgrey)
...
![Dashboard Preview](outputs/figures/00_dashboard_preview.png)

> 🔗 **[Lihat Dashboard Interaktif](https://alnafs23.github.io/Peramalan-Harga-Pangan-/dashboard/)** — jelajahi tren harga, volatilitas, dan indikator fintech secara langsung di browser.
...
atau kunjungi versi live-nya di [GitHub Pages](https://alnafs23.github.io/Peramalan-Harga-Pangan-/dashboard/).
...
<p align="center"><i>Dibuat sebagai bagian dari portofolio analisis data.</i></p>ua sisi yang jarang disandingkan:
- **Sisi harga** — pergerakan harga pangan tingkat konsumen nasional
- **Sisi pembiayaan** — kondisi akses modal lewat fintech P2P lending (LPBBTI), termasuk penyaluran khusus
  ke sektor Pertanian, Kehutanan, dan Perikanan
